...
RC = [None, (5, 7), (6, 9), (7, 11), (8, 12), (9, 14),
      (10, 15), (11, 17), (12, 19), (13, 20)]
# level 1 to 9
...
class Grid:
        ...
        for i in range(10000):
            ...
            for sq0 in squares:
                if sq0.group == 0:
                    gp = 0
                    unchanged = False
                    if squares[sq0.N].group > 0:
                        gp = squares[sq0.N].group
                    elif squares[sq0.S].group > 0:
                        gp = squares[sq0.S].group
                    elif squares[sq0.E].group > 0:
                        gp = squares[sq0.E].group
                    elif squares[sq0.W].group > 0:
                        gp = squares[sq0.W].group
                    sq0.group = gp
            if unchanged:
                break
    ...
    def fill_in_singles(self):
        for sq in squares:
            ...
            if gp > -1:
                k = 0
                ng = squares[sq.N].group
                sg = squares[sq.S].group
                eg = squares[sq.E].group
                wg = squares[sq.W].group
                if ng == -1 or ng != gp:
                    k += 1
                if sg == -1 or sg != gp:
                    k += 1
    ...
    def draw(self):
        ...
        for sq in squares:
            if sq.group > -1:
                pygame.draw.rect(
                    g.screen, colours[sq.colour], (sq.x, sq.y, d, d))
